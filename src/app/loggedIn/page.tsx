...
if (!process.env.NEXT_PUBLIC_JIFFYSCAN_API_KEY)
    throw new Error("Missing NEXT_PUBLIC_JIFFYSCAN_API_KEY");

// Define the chains with their respective entry points and RPC URLs
const chains = [
    { name: "Fuse", chain: fuse, rpcUrl: `https://api.pimlico.io/v2/${fuse.id}/rpc?apikey=${process.env.NEXT_PUBLIC_PIMLICO_API_KEY}`, explorerUrl: "https://explorer.fuse.io/tx/" },
    { name: "Sepolia", chain: sepolia, rpcUrl: `https://api.pimlico.io/v2/${sepolia.id}/rpc?apikey=${process.env.NEXT_PUBLIC_PIMLICO_API_KEY}`, explorerUrl: "https://sepolia.etherscan.io/tx/" }
];
